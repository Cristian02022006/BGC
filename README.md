...
En historial, la interfaz es dividida en dos apartados, del lado izquierdo se mostrarán las anomalías registradas en la base de datos, estas con base a las reglas de tiempo, protocolo y dirección.
 Reglas:
